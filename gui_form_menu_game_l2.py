...
class FormGameLevel1(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.player_1 = Player(x=0,y=500,speed_walk=6,speed_run=12,gravity=14,jump_power=30,frame_rate_ms=100,move_rate_ms=50,jump_height=140,p_scale=1.8,interval_time_jump=300)

        self.enemy_list = []
        self.enemy_list.append (Enemy(x=450,y=400,speed_walk=6,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.6,interval_time_jump=300))
        self.enemy_list.append (Enemy(x=900,y=400,speed_walk=6,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.6,interval_time_jump=300))

        #///////////////////////////
        self.object_list = []
        self.object_list.append(Object(x=100,y=100,speed_walk=6,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=1,interval_time_jump=300))

        self.plataform_list = []
        self.plataform_list.append(Plataform(x=0,y=750,width=50,height=50,type=1))
        self.plataform_list.append(Plataform(x=50,y=750,width=50,height=50,type=1))
        self.plataform_list.append(Plataform(x=100,y=750,width=50,height=50,type=1))

        self.plataform_list.append(Plataform(x=250, y=700, width=50, height=50, type=1))
        self.plataform_list.append(Plataform(x=300, y=700, width=50, height=50, type=1))
        self.plataform_list.append(Plataform(x=350, y=700, width=50, height=50, type=1))

        self.plataform_list.append(Plataform(x=0, y=600, width=50, height=50, type=1))
        self.plataform_list.append(Plataform(x=50, y=600, width=50, height=50, type=1))
        self.plataform_list.append(Plataform(x=100, y=600, width=50, height=50, type=1))
