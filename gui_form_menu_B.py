...
class FormMenuB(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.boton1 = Button(master=self,x=50,y=30,w=200,h=100,color_background=C_WHITE,color_border=None,image_background=None, on_click=self.on_click_boton1,on_click_param="form_game_L1",text="Back",font="Helvetica",font_size=30,font_color=C_BLACK)
        self.boton2 = Button(master=self,x=50,y=133,w=200,h=100,color_background=C_WHITE,color_border=None, image_background=None, on_click=self.on_click_boton1,on_click_param="form_volumen",text="Volume",font="Helvetica",font_size=30,font_color=C_BLACK)
        self.boton3 = Button(master=self, x=50, y=236, w=200, h=100, color_background=C_WHITE, color_border=None, image_background=None, on_click=self.on_click_boton1, on_click_param="form_menu_A", text="Menu", font="Helvetica", font_size=30, font_color=C_BLACK)
